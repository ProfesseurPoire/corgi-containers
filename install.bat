...
rmdir /s /q "C:\Program Files\corgi-containers"
...
for %%i in ( x64) do (
    ...
    for %%j in (Debug Release) do (
        ...
        cmake -DCMAKE_BUILD_TYPE=%%j -DCMAKE_INSTALL_PREFIX="C:\\Program Files\\corgi-containers" -DBUILD_TESTS=OFF -DBUILD_EXAMPLES=OFF -G "Visual Studio 16 2019" -A x64 ..\..\..
